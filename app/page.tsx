          ...
          <div key={step} className="flex flex-col items-center">
            ...
            <div
              className={`text-xs mt-2 text-center ${
                step <= currentStep ? "text-green-500" : "text-gray-500"
              }`}
            >
              {step === 1 && "Fill details"}
              {step === 2 && "Select scan"}
  ...
  const DiscountBanner = () => (
    <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-6 text-center">
      <p className="text-sm text-gray-700">
        <span className="font-semibold text-orange-600">50% discount</span> as
        an introductory offer.{" "}
        <span className="font-medium">
          Call us to book or walk-in to avail!
        </span>
      </p>
    </div>
  );
  ...
  const handleConfirmAppointment = async () => {
    ...
    try {
      ...
      const medivaBookingData: CreateBookingRequest = {
        ...
        selectedTime: formData.selectedTime, // Use current time in Indian timezone (IST) HH:MM format
      };
      ...
      const result: CreateBookingResponse | ErrorResponse =
        await response.json();
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Select
                    ...
                    onValueChange={(value) =>
                      updateFormData("howDidYouHear", value)
                    }
                  >
                    <SelectTrigger className="text-gray-500">
                  ...
                  {generateDates().map((date) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        toast({
                          title: "📅 Date Selected!",
                          description: `Appointment date set for ${formatDate(
                            date
                          )}. Now choose your preferred time.`,
                          variant: "default",
                          duration: 3000,
                        });
                      }}
              ...
              {formData.selectedDate && (
                <div>
                  ...
                  <div className="space-y-3">
                    {Object.entries(timeSlotsByPeriod).map(
                      ([period, slots]) => (
                        <div
                          key={period}
                        ...
                        >
                          <button
                            onClick={() =>
                              setExpandedPeriod(
                                expandedPeriod === period ? null : period
                              )
                            }
              ...
              <div className="flex gap-3 mt-6">
                ...
                <Button
                  ...
                  disabled={
                    ...
                    !formData.selectedTime ||
                    isSubmitting ||
                    isSlotBooked(formData.selectedTime)
                  }
                  className="flex-1 bg-green-500 hover:bg-green-600"
                >
